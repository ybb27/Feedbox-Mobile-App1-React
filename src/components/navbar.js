      ...
      <header data-role="Header" className="navigation-container">
            ...
            >
              ...
              <ul data-thq="thq-dropdown-list" className="navbar-dropdown-list">
                ...
                >
                  ...
                  >
                    <span className="navbar-text1">CSS</span>
                  </div>
                </li>
                <li
                  data-thq="thq-dropdown"
                ...
                >
                  ...
                  >
                    <span className="navbar-text2">Python</span>
                  </div>
                </li>
                <li
                  data-thq="thq-dropdown"
                ...
                >
                  ...
                  >
                    <span className="navbar-text3">Java</span>
                  </div>
                </li>
              </ul>
            </div>
        ...
        <div data-role="MobileMenu" className="navigation-mobile-menu">
          ...
          <div className="navbar-social-media">
            <span className="navbar-text4">{props.text}</span>
